                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <button
                                                ...
                                                className="text-cafe-400 hover:text-cafe-700 transition-colors p-1 rounded-lg hover:bg-cafe-50"
                                                title="แก้ไขวัตถุดิบ"
                                            >
                                                <Edit2 size={16} />
                                            </button>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {parseFloat(buyPrice) > 0 && (newIngredient.conversionRate || 0) > 0 && (
                                    <div className="flex items-center justify-between p-3 bg-green-50 border border-green-100 rounded-lg">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <p className="text-xs text-green-800 font-medium">ต้นทุนจริงต่อ {newIngredient.unit}</p>
                                                <p className="text-[10px] text-green-600">คำนวณอัตโนมัติ</p>
                                            </div>
                                        </div>
                    ...
                    <div className="flex justify-end gap-3 pt-6 border-t border-cafe-100">
                        <button
                            ...
                            className="px-5 py-2.5 text-cafe-600 font-medium hover:bg-cafe-50 rounded-xl transition-colors"
                        >
                            ยกเลิก
                        </button>
                        <button
                            type="submit"
                            className="px-5 py-2.5 bg-cafe-900 text-white font-bold rounded-xl hover:bg-cafe-800 shadow-lg hover:shadow-xl transition-all flex items-center gap-2"
                        >
                            <Plus size={18} />
                            เพิ่มวัตถุดิบ
                        </button>
